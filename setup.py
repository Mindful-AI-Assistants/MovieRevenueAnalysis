...
setup(  
    name='MovieRevenueAnalysis',                  # Substitua pelo nome do seu projeto  
    ...
    url='https://github.com/Mindful-AI-Assistants/MovieRevenueAnalysis'  # URL do repositório do seu projeto  
